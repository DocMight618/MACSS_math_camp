...
Try it out, how many derivatives? What are they? 
...
$$\frac{\partial^2 f}{\partial y \partial x}(x,y) = 0$$
...
Find all first derivatives, second derivatives, and partial derivatives. 
--
$$\frac{\partial f}{\partial x}(x,y) = 2y^2+ 3-3yx^2$$
$$\frac{\partial f}{\partial y}(x,y) = 4xy+ 4-x^3$$
--
$$\frac{\partial^2 f}{\partial x^2}(x,y) = -6xy, \frac{\partial^2 f}{\partial y^2}(x,y) = 4x$$
...
* **Hessian** matrix of second derivatives, *including partials*. This is a matrix of derivatives, typically of a vector. 
