...
* Exam TOMORROW!
* All calculators claimed -- bring one if you'd like
* Not yet enough questions to circulate (need ~2 more people)
...
* Counts: if only two choices, use z test for proportions, if lots of choices or table, use $\chi^2$
...
* First: CI for 2014 (point estimate $\pm$ $z^*$*se)
