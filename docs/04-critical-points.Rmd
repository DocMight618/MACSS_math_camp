...
```{r inflect, fig.width=8, fig.height=6, out.width="85%"}
fx <- function_plot +
...
```{r inflect-1, fig.width=8, fig.height=6, out.width="85%"}
fx <- function_plot +
  stat_function(fun = function(x) (x^3 - 15 * x^2 + 60 * x + 30) / 15, size = 0.5) +
  geom_abline(slope = -1, intercept = (10 + (1 / 3)), linetype = 4, color = "blue", linewidth = 0.8) +
  labs(y = expression(f(x))) +
...
```{r base-plot, fig.width=8, fig.height=6, out.width="85%"}
f0 <- function_plot +
...
```{r optims, dependson = "base-plot", fig.width=8, fig.height=6, out.width="85%"}
f0 +
  geom_point(
    data =
      tibble(
...
```{r newton-raphson, fig.width=8, fig.height=6, out.width="85%"}
