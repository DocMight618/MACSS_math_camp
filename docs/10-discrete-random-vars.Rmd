...
* A model to **count the number of trials** of a Bernoulli **before success occurs the FIRST time**
--
...
--
$$log(0.05) = - \lambda \, \text{ therefore } \lambda \approx 3.0$$
---
# Poisson plot
...
So: max variance at $0.5(1 - 0.5 ) = 0.2$
