...
| 5-Sep | Probability | [Discrete random variables](https://jmclip.github.io/MACSS_math_camp/10-discrete-random-vars.html) | [Pset 6 pdf](problem_sets/06-discrete-random-variables.pdf), [tex](problem_sets/06-discrete-random-variables.tex) + & [answer key](solutions/pset6_answerkey.pdf)
...
| 9-Sep | Probability | [Multivariate distributions](https://jmclip.github.io/MACSS_math_camp/12-multivariate-pdf.html)  | [Pset 8 pdf](problem_sets/08-multivariate-pdf.pdf), [tex](problem_sets/8-multivariate-pdf.tex) & [answer key](solutions/pset8_answerkey.pdf)
| 10-Sep | Statistical inference  | [Classical statistical inference](https://jmclip.github.io/MACSS_math_camp/13-frequentist-inference.html)| [Pset 9 pdf](problem_sets/09-frequentist-inference.pdf), [tex]((problem_sets/9-frequentist-inference.tex)) & [answer key](solutions/pset9_answerkey.pdf)
